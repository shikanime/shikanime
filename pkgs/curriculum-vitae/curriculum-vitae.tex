...
\resumeItemListStart{}
\resumeItem{
  Industrialisation of satellite image analysis research with a team of data
  scientists, on the Google Earth Engine. To monitor, report and optimise crops,
  solar panel yields and the environmental impacts of petrochemical
  infrastructures.
}
\resumeItemListEnd{}
