...
\resumeItemListStart{}
\resumeItem{
	Successfully integrated Evidian IDaaS software product in Google Cloud
	Marketplace, which involved developing event-driven integrations with internal
	Google Marketplace APIs.
}
\resumeItem{
	Developed the backend API for subscription creation, consumption monitoring,
	customer registration, and integration with the Evidian backoffice for service
	instance deployment requests, enhancing overall service delivery capabilities.
}
\resumeItemListEnd{}
