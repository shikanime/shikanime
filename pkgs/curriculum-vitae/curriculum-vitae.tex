...
\resumeItemListStart{}
\resumeItem{
  Designing and building a critical high volume gateway component with failure
  redundency and canary deployment for routing Renault smart car messages globally
  on Kubernetes.
}
\resumeItemListEnd{}
