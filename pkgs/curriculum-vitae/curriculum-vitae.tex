...
\resumeItemListStart{}
\resumeItem{
  Designed and built a high-volume critical gateway component, secured by
  end-to-end encryption with regional redundancy, canary deployment for routing
  messages from the globally on Kubernetes.
}
\resumeItemListEnd{}
...
\resumeItem{
  ...
  js\textunderscore{}of\textunderscore{}ocaml in the build system and the build
  pipeline and making artifacts available to the different projects.
}
\resumeItem{
