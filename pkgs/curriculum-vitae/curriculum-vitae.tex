...
\resumeItemListStart{}
\resumeItem{
  Lead multiple data platforms for organizations of all sizes to leverage the
  Google Cloud Platform, covering business use case based strategies with a wide
  variety of data sources from on-premises and the cloud.
}
\resumeItemListEnd{}
