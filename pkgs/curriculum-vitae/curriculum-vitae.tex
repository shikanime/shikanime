...
\resumeItem{
  Automate the whole infrastructure, application build and deployment pipelines
  via Terraform and Gitlab.
}
\resumeItem{
...
\resumeItem{
  Audit of data sources SQL Server, CSV and Excel data sources; for the
  implementation of an ingestion and presentation strategy.
}
\resumeItem{
