{
  ...
  outputs =
    inputs@{ self, nixpkgs, nixos-hardware, home-manager, flake-parts, ... }:
      ...
      flake = {
        ...
        homeConfigurations = {
          ...
          "vscode@shikanime.kaltashar" = home-manager.lib.homeManagerConfiguration {
            ...
            modules = [
              ./modules/home/hosts/devcontainer-vscode-shikanime.nix
              ./modules/home/identities/shikanime.nix
            ];
          };
          ...
          "vscode@servier.baltashar" = home-manager.lib.homeManagerConfiguration {
            ...
            modules = [
              ./modules/home/hosts/devcontainer-vscode-servier.nix
