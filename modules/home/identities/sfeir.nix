...

{
  ...
  programs.git.extraConfig.url = {
    "ssh://git@gitlab.sfeir.internal/Sfeir".insteadOf = "git@gitlab.com/Sfeir";
    "ssh://git@gitlab.sfeir.internal/Sfeir".insteadOf = "ssh://git@gitlab.com/Sfeir";
    "ssh://git@gitlab.sfeir.internal/phetsinorath.w".insteadOf = "git@gitlab.com/phetsinorath.w";
